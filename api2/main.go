...
func main() {
	...
	http.HandleFunc("/api2/"+CARNET+"/call-api1", func(w http.ResponseWriter, r *http.Request) {
		callAPI(w, r, "API1", "localhost", "8001")
	})
	http.HandleFunc("/api2/"+CARNET+"/call-api3", func(w http.ResponseWriter, r *http.Request) {
